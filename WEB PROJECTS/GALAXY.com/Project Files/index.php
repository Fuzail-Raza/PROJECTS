...
<body>
  <nav class="navbar navbar-expand-lg fixed-top navbar-scroll" style="background-color: #252525">
    <div class="container-fluid">
      ...
      <a class="navbar-brand " href="#" sytle="text-color: #fff;">GALAXY</a>
      <div class="collapse navbar-collapse" id="navbarExample01">
        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
          ...
          <li class="nav-item">
            <a class="nav-link" href="index/News.php" rel="nofollow" >News</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="index/Ranking-insert.php" >Ranking</a>
          </li>

          <li class="nav-item">
            <a class="nav-link" href="index/videos.php" >Videos</a>
          </li>
          <li class="nav-item " style="margin-right: 21px;" >
            <a class="nav-link" href="index/shop.php">Shop</a>
  ...
  <div class="container" style="background-color:#f0f0f0;border-radius:15px;padding:40px;height: fit-content;margin-bottom:10px;">
    <div class="row">
      <div class="col-lg-12 col-md-12 col-sm-12 sidebar-page-container">
        <div class="sidebar">
          <div class="sidebar-widget sidebar-post">
            <div class="widget-title">
              <h3 style="padding:20px;">News Feed</h3>
            </div>
  ...
  display: block;
    text-align: center;background-color:#f0f0f0; border-radius :  10px;margin-left:20%;margin-right:20%;padding:5px;">
    <h1>Trending News</h1>  
    </div>
    <div class="container " style="background-color:#d6cccc;margin-top: 4px; border-radius: 5px; margin-bottom: 4px;padding:20px;">
    <div class="min-text">
              ...
              <div class="carousel-item active">
                <div class="row">
                  <div class="col-md-4 mb-3">
                    <div class="card">
                      <video class="video-fluid" alt="100%x280" src="https://geosuper.tv/assets/uploads/updates/2020-12-18/7446_7356215_updates.jpg"></video>
                      <div class="card-body">
  ...
  <footer class="text-center text-white" style="background-color: rgb(70, 70, 70)">
    ...
    <a class="nav-link" href="index/contactus.php"  > <button type="button" class="btn btn-secondary" style="margin-bottom : 10px;">Conact us</button></a>
    <!-- Grid container -->
